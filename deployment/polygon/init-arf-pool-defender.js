...
const poolTreasury = "0xA5Efe3F7C92DB557E00F002e40A425d0b70cb9DA"
...
async function initBaseCreditPoolFeeManager() {
    ...
    await sendTransaction("FeeManager", feeManager, "setMinPrincipalRateInBps", [4999]);
...
async function initBaseCreditPoolConfig() {
    ...
    // await sendTransaction("ArfPoolConfig", poolConfig, "setAPR", [1300]);
    // await sendTransaction("ArfPoolConfig", poolConfig, "setReceivableRequiredInBps", [0]);
    // await sendTransaction("ArfPoolConfig", poolConfig, "setPoolPayPeriod", [30]);
    // await sendTransaction("ArfPoolConfig", poolConfig, "setPoolToken", [
    //     deployedContracts["ArfHDT"],
    // ]);
    // await sendTransaction("ArfPoolConfig", poolConfig, "setWithdrawalLockoutPeriod", [30]);
    // await sendTransaction("ArfPoolConfig", poolConfig, "setPoolDefaultGracePeriod", [10]);
    // await sendTransaction("ArfPoolConfig", poolConfig, "addPoolOperator", [deployer.address]);


    await sendTransaction("ArfPoolConfig", poolConfig, "setPoolOwnerTreasury", [poolTreasury]);

    await sendTransaction("ArfPoolConfig", poolConfig, "setCreditApprovalExpiration", [10]);
