...
const REQUEST_NETWORK_NFT_ADDRESS = "0xf98b8a94edbc9628b7b2141465980f2c3acab23f";
...
async function verifyReceivableFactoringPool() {
    ...
    console.log(`pool liquidity: ${await usdc.balanceOf(pool.address)}`);
    ...
    await mint(pool.address, paymentAmount);
    await pool
        .connect(pdsService)
