...
/**
 * @notice HumaSBT (Huma Soul-bound Token) is a non-transferrable liability token
 * that is issued to the borrower. They cannot transfer away this token.
 ...
 */
contract HumaBorrowingSBT is ERC20 {
    address issuer;

    /**
     * @param _issuer the contract that issues the SBT. Only it can remove it.
     */
    constructor(address _issuer)
        ERC20("Huma Borrowing Soul-bound Token", "HumaBorrowingSBT")
    {
        issuer = _issuer;
    }
